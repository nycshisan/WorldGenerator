...
namespace wg {
    ...
    std::string DistField::getHintLabelText() {
        return "Block edges distance field generated.";
    }

    void DistField::generate() {
        delete[] _dfx;
        delete[] _dfy;
    ...
    void DistField::prepareVertexes(Drawer &drawer) {
        drawer.addSprite(_s);
    }
